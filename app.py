"""
Created on 23 Jan 2021 15:38

@author: Jean Bernard Mathias
...
st.set_page_config(page_title="NLP Simple Examples", page_icon=":facebook", layout='centered',
...
def main():
    ...
    st.sidebar.image("https://www.centreofexcellence.com/app/uploads/2016/09/nlp-diploma-course.jpg",
    ...
    if choice == 'Text Analysis':
        ...
        if len(raw_text) < 3:
            ...
            st.write(lang)
            tran_options = st.selectbox("Select translation language",
    ...
    # About CHOICE
        ...
        ##### By
        + **[Learning Streamlit  LAB](http://www.tolmai.co.za)**
        + [jeanbernard.mathias@gmail.com](mailto:jeanbernard.mathias@gmail.com)
        """)
